...
Добавьте к строке res_str строку str. При объединении строк необходимо 
контролировать выход за пределы массива res_str. То есть, из строки str можно максимум 
скопировать до 99-го индекса строки res_str. 
...
int main(void)
{
    ...
    size_t max_add = sizeof(res_str) - 1;
